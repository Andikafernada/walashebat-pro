                        ...
                        @foreach ($structures as $st)
                            <div class="flex items-center justify-between gap-4 py-3 hover:bg-slate-50/80 px-2 rounded-xl transition-colors">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 text-indigo-700 font-bold text-xs border border-indigo-200/60 shadow-xs">
