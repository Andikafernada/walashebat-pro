...
@section('content')
    ...
    <div class="text-center mb-8">
        ...
        <h2 class="text-2xl font-bold text-slate-900">Verifikasi WhatsApp</h2>
            ...
            <div class="flex gap-2 justify-center mt-3">
                @for($i = 0; $i < 6; $i++)
                    <input
                        ...
                        "
                        class="otp-input w-12 h-14 text-center text-xl font-bold rounded-xl border-2 border-slate-200 bg-slate-50 focus:bg-white focus:border-indigo-500 @error('otp') border-red-300 @enderror"
                        required
                    >
                @endfor
            </div>
